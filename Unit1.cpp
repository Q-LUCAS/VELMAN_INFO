...
void __fastcall TForm1::Timer1Timer(TObject *Sender)
{
	  ...
	  conn=mysql_real_connect(mySQL, "192.168.65.233", "root", "Root", "S", 0, NULL, 0);
	  ...
	  Counter1->Text = IntToStr((__int64)ReadCounter(1));
	  Counter2->Text = IntToStr((__int64)ReadCounter(2));
	  i = ReadAllDigital();
	  ...
	  {
		  stringbuilder << "INSERT INTO `MeteoTp4` (`Temperature`) VALUES (" << Data2 << ")";
